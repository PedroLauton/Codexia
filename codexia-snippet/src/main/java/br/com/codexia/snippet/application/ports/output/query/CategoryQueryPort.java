...
public interface CategoryQueryPort {
    ...
    boolean isAncestorOf(CategoryId potentialAncestor, CategoryId target, WorkspaceId workspaceId);
    boolean hasChildren(CategoryId categoryId, WorkspaceId workspaceId);
}
